...
while i!=I:
        ...
        print('暂停：', sleeptime(12, 0, 0), '秒')
        seconds = sleeptime(12, 0, 0)
        time.sleep(seconds)
        from datetime import datetime
        ...
        starttime = this_month_start - relativedelta(months=0)
        ...
        mycursor = db.cursor()
        sql = "DELETE FROM t_bas_fence_alarm_vehicle_statistics_data WHERE statistics_date = '{}'".format(starttime.strftime("%Y-%m"))
