...
def t_bas_basic_data_pass():
            ...
            #     starttime, endtime)
            # t_bas_pass_data_71 = get_df_from_db(sql)
            sql1 = "select  station_code,station_status,station_type,is_check_station,station_name, area_county from t_sys_station where is_deleted = 0  and station_status = 0 and station_type in (31,71) "
            ...
            #
            # next_time = now_time + datetime.timedelta(minutes=+10)
...
def t_bas_basic_data_pass2():
    ...
    t2 = Timer(timer_start_time2, t_bas_basic_data_pass2)  # 此处使用递归调用实现
    t2.start()

if __name__ == "__main__":
    t_bas_basic_data_pass()
    t_bas_basic_data_pass2()
