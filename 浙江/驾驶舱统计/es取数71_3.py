...
es = Elasticsearch(hosts=["http://username:password@192.168.1.61:9200/"])
body = {
...
print('1')
result = es.search(index="t_bas_pass_data_31", body={"query": {"match_all": {}}}, filter_path=['hits.hits._source'])
print(result)
...
print('3')
allDoc = es.search(index='t_bas_pass_data_31', body=body)
print('4')
items = allDoc['hits']['hits']
