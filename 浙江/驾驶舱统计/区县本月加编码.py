...
区县超限100明细= pd.read_excel(r"G:\智诚\日常给出数据汇总\月通报\10月统计\驾驶舱\区县汇总非现.xlsx")
...
最终= pd.merge(区县超限100明细,地市编码表,left_on=['区县'],right_on=['area_name'],how='left')

print(最终)
最终.to_excel(r"G:\智诚\日常给出数据汇总\月通报\10月统计\驾驶舱\非现加编码.xlsx")
# print(最终.info())
