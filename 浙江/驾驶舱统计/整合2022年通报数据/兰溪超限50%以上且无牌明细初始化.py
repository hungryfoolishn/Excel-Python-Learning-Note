...
def t_bas_basic_data_pass():
            ...
            ##原始表获取
            sql = """ SELECT record_code,out_station,out_station_time,car_no,total_weight,limit_weight,overrun,axis,site_name,direction,overrun_rate,area_city,area_county FROM t_bas_over_data_31 a  WHERE out_station_time >= '2023-01-01 00:00:00' 
            AND out_station_time < '2023-08-01 00:00:00' and a.area_county=330781 and a.car_no like '%牌%' and a.overrun_rate>50 and a.allow is NULL and a.is_unusual =0 """
