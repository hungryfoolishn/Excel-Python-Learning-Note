...
file_name = r"G:\智诚\2023日常给出数据\省通报\202308\0901test.xlsx"
...
def over_100_num():
        ...
        满足证据条件数 = U_过车_站点表[((U_过车_站点表['车牌号码'] == '无牌') & (U_过车_站点表['是否是需采集的数据'] == '满足'))].groupby(["地市", "区县"])[
...
if __name__ == "__main__":
    ...
    with pd.ExcelWriter(r'C:\Users\stayhungary\Desktop\8月通报案件处罚数0908v2.0.xlsx') as writer1:
