...
while i!=I:
    ...
    sql = "select  area_city,area_county,out_station,out_station_time,car_no,total_weight,limit_weight from t_bas_pass_data_71 where out_station_time >= '{} 00:00:00' and out_station_time < '{} 00:00:00'  and area_county=330781 ".format(
        starttime, endtime)
    ...
    #     starttime, endtime)
    # t_bas_pass_data_71 = get_df_from_db(sql)
    sql1 = "select  station_code,station_status,station_type,station_name, area_county from t_sys_station where is_deleted = 0  and station_status=0 and station_type！=21 station_type！=41 and area_county=330781 "
