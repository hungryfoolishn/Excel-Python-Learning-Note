...
class Reports:
    out_file_月报 = r'C:\Users\liu.wenjie\Desktop\月报\1A最新\月报'
    charts_path = r'C:\Users\liu.wenjie\Desktop\月报\1A最新\charts'
    file_name = r"C:\Users\liu.wenjie\Desktop\月报\1A最新\静态表\1030test.xlsx"
    ...
    def __init__(self):
        ...
        out_file_name = r'C:\Users\liu.wenjie\Desktop\月报\1A最新\月报\{}月通报数据{}v1.0.xlsx'.format(this_month, today2)
        q案件 = '2023-01-01'
        s案件 = endtime
    ...
    def t_bas_basic_data_report(self):
        ...
        df_源头['区县编码'] = df_源头['区县编码'].astype('int')
