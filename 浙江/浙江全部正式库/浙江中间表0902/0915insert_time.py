...
while i!=I:
    ...
    sql = "select  area_city,area_county,out_station,out_station_time,insert_time,car_no,total_weight,limit_weight from t_bas_pass_data_31 where insert_time >= '{} 00:00:00' and insert_time < '{} 00:00:00' ".format(
        starttime, endtime)
    t_bas_pass_data_31 = get_df_from_db(sql)

    # and area_county = 330781

    sql = "select  area_city,area_county,out_station,out_station_time,insert_time,car_no,total_weight,limit_weight from t_bas_pass_data_71 where insert_time >= '{} 11:00:00' and insert_time < '{} 00:00:00'  ".format(
        starttime, endtime)
    ...
    wide_table_31 = pd.DataFrame(wide_table_31,
                                 columns=['out_station', 'statistics_date','insert_time','pass_num', 'truck_num',
                                          'overrun_num', 'no_car_num', 'overrun_0',
