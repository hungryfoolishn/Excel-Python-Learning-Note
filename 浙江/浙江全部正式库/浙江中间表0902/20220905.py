...
while i!=I:
    ...
    print('暂停：', sleeptime(6, 0, 20), '秒')
    seconds = sleeptime(0, 0, 10)
    time.sleep(seconds)
    from datetime import datetime
    ...
    sql = "select  area_city,area_county,out_station,out_station_time,car_no,total_weight,limit_weight from t_bas_pass_data_31 where out_station_time >= '{} 00:00:00' and out_station_time < '{} 00:00:00' ".format(
        starttime, endtime)
