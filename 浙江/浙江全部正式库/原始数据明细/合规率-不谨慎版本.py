...
sql = "SELECT * FROM t_bas_over_data_31 where out_station_time >= '2022-01-01 00:00:00' and  out_station_time <'2022-08-30 00:00:00' and overrun_rate>80  AND allow IS NULL AND is_unusual = 0 "
t_bas_over_data_31=get_df_from_db(sql)

sql = "SELECT * FROM t_bas_over_data_collection_31 where out_station_time >= '2022-01-01 00:00:00' and out_station_time <'2022-08-30 00:00:00'  and overrun_rate>80 "
...
if cs=='浙江':
    ...
    for i in city_list:
        ...
        with pd.ExcelWriter('C:/Users/Administrator/Desktop/输出报表/合规率/截止0829月{}市超限80%以上数据.xlsx'.format(i))as writer1:
