...
if cs == '浙江':
    ...
    with pd.ExcelWriter('{}/杭州市百吨王明细数据.xlsx'.format(q))as writer1:
        百吨王车辆统计.to_excel(writer1, sheet_name='百吨王车辆数统计', index=True)
        U_过车_站点表.to_excel(writer1, sheet_name='Sheet1', index=True)
    ...
    with pd.ExcelWriter('{}/湖州市百吨王明细数据.xlsx'.format(q))as writer1:
        百吨王车辆统计.to_excel(writer1, sheet_name='百吨王车辆数统计', index=True)
        U_过车_站点表.to_excel(writer1, sheet_name='Sheet1', index=True)
    ...
    with pd.ExcelWriter('{}/{}市百吨王明细数据.xlsx'.format(q,cs))as writer1:
        百吨王车辆统计.to_excel(writer1, sheet_name='百吨王车辆数统计', index=True)
        U_过车_站点表.to_excel(writer1, sheet_name='Sheet1', index=True)
