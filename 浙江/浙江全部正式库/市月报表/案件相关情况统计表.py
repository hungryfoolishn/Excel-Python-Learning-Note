...
if cs == '浙江':
    ...
    print(W_案件统计)
    q = input("请输入储存路径(C:/Users/Administrator/Desktop/输出报表/2022年处罚案件统计情况/)：")
    W_案件统计.to_excel("{}2022年处罚案件情况统计.xlsx".format(q))
    ...
    if cs == '杭州1':
        ...
        print(附件10)
        q = input("请输入储存路径(C:/Users/Administrator/Desktop/输出报表/杭州市月报表/)：")
        with pd.ExcelWriter('{}杭州案件处罚.xlsx'.format(q))as writer1:
        ...
        print(湖州市附件4)
        q = input("请输入储存路径(C:/Users/Administrator/Desktop/输出报表/湖州市月报表/)：")
        with pd.ExcelWriter('{}湖州案件处罚.xlsx'.format(q))as writer1:
        ...
        q = input("请输入储存路径(C:/Users/Administrator/Desktop/输出报表/其他市月报表：")
        with pd.ExcelWriter('{}/{}案件处罚.xlsx'.format(q,cs))as writer1:
